...
async function imprimeLista(valida, resultado, identificador = '') {
  if (valida) {
    console.log(
      ...
      // identificador vai receber o nome do arquivo pra imprirmir junto com o link
...
function processaTexto(argumentos) {
  ...
  // o then usa uma função de callback dentro originária da função na qual ele tá inserido p então executar sua ação