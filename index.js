...
function pegaArquivo(caminhoArquivo) {
  ...
  fs.promises.readFile(caminhoArquivo, encoding) //é assincrona já que não há como saber o tamanho do arquivo, o que pode causar travamento, por isso o uso da promises, then e catch
